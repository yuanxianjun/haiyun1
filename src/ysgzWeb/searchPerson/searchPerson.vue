                    ...
                    <div class="query_con">
                        ...
                        <div class="item">
                            ...
                            <el-radio-group v-model="query.education">
                                <el-radio v-for="smallItem in queryObj.education" :label="smallItem.name">{{smallItem.name}}</el-radio>
                            </el-radio-group>
                        </div>
                        <div class="item">
                            <div class="title">
                            ...
                            <el-radio-group v-model="query.major">
                                <el-radio v-for="smallItem in queryObj.major" :label="smallItem.name">{{smallItem.name}}</el-radio>
                            </el-radio-group>
                        </div>
                        <div class="item">
                            <div class="title">
                ...
                <div class="query">
                    <div class="query_con">
                        <div class="item">
                                ...
                                <el-form :model="query" :rules="rules" ref="trainForm" label-width="0px" class="demo-ruleForm">
                                        ...
                                        <el-checkbox-group v-model="query.train">
                                            <div v-for="smallItem in queryObj.train">
                                                ...
                                                <template v-if="smallItem.name != '单杠卷身上'">
                                                    <el-input suffix-icon="el-input-time" >
                                                    </el-input>
                            ...
                            <div class="resultList">
                                ...
                                <div class="t_body">
                                    <div class="t_row" v-for="person in personList">
                                        ...
                                        <div class="t_r"><a href="personInfo.html">{{person.name}}</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        data() {
            ...
            return {
                rules:{
                    train: [
                        {validator: validateTrain, trigger: 'blur'}
                    ],
                },
                // 实时警情数据
                slectProps: {
        ...
        watch:{
            ...
            'query.certificate':function(newVal,oldVal){
                if(newVal.length > oldVal.length){ //添加元素
                    this.params.push({
                        type:'certificate',
                    ...
                    this.params = this.params.filter(item => (item.type !='certificate' || (item.type =='certificate' && item.value!= uncheck)));
                }
            },
            ...
            'query.reward':function(newVal,oldVal){
                if(newVal.length > oldVal.length){ //添加元素
                    ...
                    var uncheck = this.diffArray(oldVal,newVal);
                    this.params = this.params.filter(item => (item.type !='reward' || (item.type =='reward' && item.value!= uncheck)));
                }
            },
            ...
            'query.train':function(newVal,oldVal){
                if(newVal.length > oldVal.length){ //添加元素
                    ...
                    var uncheck = this.diffArray(oldVal,newVal);
                    this.params = this.params.filter(item => (item.type !='train' || (item.type =='train' && item.value!= uncheck)));
                }
            }
        },
        mounted() {
        ...
        methods: {
            ...
            deleteParam:function(data){
                if('certificate' == data.type || 'reward' == data.type || 'train' == data.type ){
                    this.query[data.type] = this.query[data.type].filter(item => item != data.value);
                }else{
