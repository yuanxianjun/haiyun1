              ...
              <div class="_swiper">
                ...
                <div class="swiper-container">
                  ...
                  >
                    <div
                      class="swiper-slide"
                      v-for="(cer,index) in personData.certificateList"
                      :class="'cer_'+cer"
                      :key="index+'cer'"
                    ></div>
                  </div>
                ...
                <a
                  :class="[personData.certificateList.length == 4 ? '_disabled':'','button-next']"
                  @click="goNext"
                ></a>
              </div>
            </div>
              ...
              <div class="lasterTrain">
                <div class="t_item" v-for="index in 6">
                  <template v-if="index <= personData.trainReport.latestTrainResult.length">
                    <div
                      class="t_header"
                    >{{personData.trainReport.latestTrainResult[index-1].title}}</div>
          ...
          <div class="item">
            ...
            <div class="info">
              <div class="doc_email">
                ...
                <div class="doc_email_item_data">
                  {{personData.docAndEmailData.receiveDoc}}/{{personData.docAndEmailData.sendDoc}}
                  <span>封</span>
                </div>
              </div>
              <div class="doc_email">
